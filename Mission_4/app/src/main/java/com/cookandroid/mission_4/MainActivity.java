package com.cookandroid.mission_4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); //레이아웃에 정의된 뷰 객체 참조
        setTitle("두 개의 이미지뷰에 이미지 번갈아 보여주기");
        ...
        int bitmapheight = bitmap.getIntrinsicHeight(); //리소스 이미지 크기 설정
